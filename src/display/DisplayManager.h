...
class DisplayManager {
 ...
 private:
  ...
  void drawTinyGlyphRows(int x, int y, const uint8_t *rows, uint16_t color, int scale);
  void drawUiGlyphScaled(int x, int y, uint32_t codepoint, uint16_t color, int scale);
